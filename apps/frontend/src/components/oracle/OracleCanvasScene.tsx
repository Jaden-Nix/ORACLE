  ...
  return (
    <section className="relative h-full min-h-[100svh] overflow-hidden bg-[#040508]">
      ...
      <div className="absolute inset-0 flex items-center justify-center px-5 pb-20 pt-16">
        <div className="w-full max-w-xl border-y border-[#c9a84c]/30 bg-[#040508]/28 px-5 py-7 text-center shadow-[0_0_80px_rgba(201,168,76,0.08)] backdrop-blur-[2px] md:px-10">
